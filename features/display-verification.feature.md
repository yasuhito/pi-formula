...
## Scenario: 確定後のみ検査へ切り替えた後に表示数式が現れる

- Given 確定後のみ検査へ切り替えた後に表示数式が現れる探索応答がある
- When 遅れて始まるストリーミング撮影の解除を調べる
- Then 撮影 marker と ACK 待ちを作らず確定後のみ検査する
